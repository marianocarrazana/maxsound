<?php get_header(); ?>
	...
	<?php if (have_posts()): while (have_posts()) : the_post(); ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class("card wrapper"); ?>>
			...
			<span class="comments"><?php if (comments_open( get_the_ID() ) ) comments_popup_link( __( 'Leave your thoughts', 'html5blank' ), __( '1 Comentario', 'html5blank' ), __( '% Comentarios', 'html5blank' )); ?></span>
			<!-- /post details -->
			...
			<p><?php _e( 'Escrito por ', 'html5blank' ); the_author(); ?></p>
